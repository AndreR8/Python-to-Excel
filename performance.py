# -*- coding: utf-8 -*-
"""
Created on Tue Jan 10 09:26:08 2023
...
"""
!!!!!CHANGE DATE EVERYDAY!!!!!CHANGE DATE EVERYDAY!!!!!!CHANGE DATE EVERYDAY!!!!!!!CHANGE DATE EVERYDAY!!!!!!CHANGE DATE EVERYDAY!!!!!!CHANGE DATE EVERYDAY!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
"""

#sums of ftds================================================CHANGE DATE!!!!!!!!!!!!!!!!!!!!!!!!!!
# Define start and end dates for date range
...
#print(ftddf['Actual Net Amount'].dtype)

# Sum of 'Value' column that match criteria

#uses float64 to find the sum of the values
#orgsum_value = ftddf.loc[(ftddf['Organic'] == 'Organic') & (ftddf['is FTD'] == 'Yes') &
#                   (ftddf['Lead Date Created'] >= pd.to_datetime(start_date)) &
#                   (ftddf['Lead Date Created'] <= pd.to_datetime(end_date))]['Actual Net Amount'].sum()#
#
...
# Define start and end dates for date range  ********************************CHANGE THIS EVERY MONTH*************************** 
...
facebookcountalld = ftddf.loc[(ftddf['Bing/Facebook/Google'] == 'Facebook') & 
                     (ftddf['is FTD'] == 'No') &   
                     (ftddf['Type'] == 'D')].shape[0]
...
performance = pd.concat([pd.Series([googleleads, googlecountftd, googlecountlateftdall_value, googleftdall_value, goog1elateftdall_value, googlecountredeposits,
                           ...
                           facebookcountftd, facebookcountlateftdall_value, facebookftdall_value, facebooklateftdall_value, facebookcountalld, facebookcountw, facebookcount6w, facebookamountallw, facebookamountalld,
